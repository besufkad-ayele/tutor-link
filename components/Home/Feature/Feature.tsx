...
const Feature = () => {
  return (
    <div className="text-black flex rounded-2xl px-28 pt-32 pb-14 justify-center items-end bg-amber-700 my-16 w-full max-w-screen flex-col">
      ...
      <div>
        <Card className="py-4">
          <CardHeader className="pb-0 pt-2 px-4 flex-col items-start">
            ...
            <h4 className="font-bold text-lg text-gray-900">scientific Study music integrated</h4>
          </CardHeader>
